 ...
 */
function theme_config_glibtheme()
{
    return array(
        'image_type' => 'png',
 ...
 */
function theme_js_libs_glibtheme()
{
    return array(
       array(
            'library'  => 'jquery',
 ...
 */
function theme_js_files_glibtheme()
{
    global $_CONF;
    return array(
    );
